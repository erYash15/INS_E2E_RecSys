...
if __name__ == "__main__":
    ...
    train_X = preprocess_content_features(train_df = train_X, save_dir= "artifacts/content_encoders")
    val_X = preprocess_content_features(train_df = val_X, save_dir= "artifacts/content_encoders")
